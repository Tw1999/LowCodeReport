...
params = {
  "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOiJlYjAzMjYyYy1hYjYwLTRiYzYtYTRjMC05NmU2NmE0MjI5ZmUiLCJDbGllbnRJZCI6IjY4YjBjOTY2LTFlZWEtNGFkYy04MWNjLTUyNmI2ZDc5NzJmMSIsIkxvZ2luVHlwZSI6IjAiLCJleHAiOjE3NzA0NDYyNzEsImlzcyI6InR3MzY5LmNvbSIsImF1ZCI6InR3MzY5LmNvbSJ9.XKxXZa3BzBzPNMzuUprBadTercm7v6vxxsVTWWep7wU",
  "params": {
    "id": "",
    "page": "1",
    "page_size": "10",
...
# 执行原始脚本
exec(open(r'C:\Tw.Erp\LowCodeReport\开发测试\test.py', encoding='utf-8').read())
