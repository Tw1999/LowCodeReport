...
params = {
    # "comm_id": "0591cfbd-d915-48d6-9831-7f6201cd4d3e",  # 不限制项目
    "fee_date_start": "2023-01-01",
    "fee_date_end": "2023-12-31",
    "debug": "1"  # debug=1返回年份SQL，debug=2返回主查询SQL
}
...
# 执行原始脚本
exec(open(r'C:\Tw.Erp\LowCodeReport\演示环境\欠费查询报表.py', encoding='utf-8').read())
